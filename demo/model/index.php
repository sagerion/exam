...
while ($a=mysqli_fetch_array($sql,MYSQLI_ASSOC)) {
    ...
    $l++;$link='';
    if($l<=2){$link='<span class="btn btn-primary btn-circle pull-right accord-action btn-xs" onclick="location.href=(`start/?id='.$b['chapter_id'].'`)">Start Test</span>';}
    else{$link='<span class="pull-right bold" style="font-size:12px"><a href="../">Upgrade To Pro</a></span>';}
     $subject_list.='

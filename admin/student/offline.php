        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 style="margin-top:0;padding-bottom:10px" class="bold text-capitalize"><i class="icon-user"></i> <?php echo $f['name'] ?> <small><?php echo $f['class'] ?><sup>th</sup> Standard</small></h3>
                        </div>
                        <div class="col-md-6">

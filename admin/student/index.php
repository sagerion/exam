...
session_admin($start);
$f='';
$out='';$test=0;$total=0;$total_test=0;$offline_test=0;$out_offline='';
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                                            ...
                                            <div class="details">
                                                <div class="number">
                                                    <span data-counter="counterup" data-value="<?php echo $test ?>"><?php echo $test ?> </span> / <?php echo $total_test ?></div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light">
                                            <div class="portlet-title">
                                                ...
                                                <div class="actions"><span class="btn btn-default btn-circle" onclick="location.href=('./online.php?id=<?php echo $_GET['id'] ?>')">View Details</span></div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light">
                                            <div class="portlet-title">
                                                ...
                                                <div class="actions"><span class="btn btn-default btn-circle" onclick="location.href=('./offline.php?id=<?php echo $_GET['id'] ?>')">View Details</span></div>
                                            </div>
                                            <div class="portlet-body">

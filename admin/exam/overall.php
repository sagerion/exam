...
if(isset($_GET['class'])){
$class=$_GET['class'];
$sql=mysqli_query($con,"select * from test where class='$class' order by start ASC");
    while($a=mysqli_fetch_array($sql,MYSQLI_ASSOC)){
        $rows.='<th>'.$a['name'].'  ('.$a['total'].')</th>';   
}
...
$sq=mysqli_query($con,"select * from user where status='y' and class='$class' order by user_id ASC");
    ...
    while($a=mysqli_fetch_array($sql,MYSQLI_ASSOC)){
        $test_id=$a['test_id'];
        $c=mysqli_query($con,"select score from test_score where test_id='$test_id' and user_id='$user_id' ");
...
<head>
    ...
    <title>Online Test Report</title>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
               <h1 class="page-title">Online Test Report</h1>
                <div class="row">
                    <div class="col-md-12">
